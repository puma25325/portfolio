<template>
    <section id="about" class="py-24 px-4 sm:px-6 md:px-12 lg:px-48">
      ...
      <div class="flex flex-col lg:flex-row justify-between items-center">
        ...
        <div class="w-full lg:w-1/2 px-2 sm:px-0" data-aos="fade-left" data-aos-delay="200">
          ...
          <p class="mb-4 sm:mb-6 text-sm sm:text-base" data-aos="flip-up" data-aos-delay="400">
            Results-driven Web Developer, Web/Graphic Designer, and Sales Executive with 3 years of experience in creating high-performing digital solutions and driving business growth.
          </p>
          <p class="mb-6 sm:mb-8 text-sm sm:text-base" data-aos="flip-up" data-aos-delay="400">
            Skilled in designing user-friendly websites, developing robust web applications, and implementing effective sales strategies. Passionate about leveraging technology and market insights to enhance brand visibility and boost revenue. Seeking opportunities to contribute my expertise in web development, design, and sales to a dynamic organization.       
          </p>
